 ...
 * Tu obsluzone sa poszczegolne operacje w zaleznosci od losowan gracza, decyzji przeciwnika, braku dostepnych pionkow, przerwaniu polaczenia
...
public class GameServer implements Runnable {
	...
	/**
	 * gniazdo pierwszego gracza
	 */
	private Socket g1Socket;
	/**
	 * gniazdo grugiego gracza
	 */
	private Socket g2Socket;
	/**
	 * obiekt wyjsciowy pierwszego gracza
	 */
	private ObjectOutputStream oosg1;
	/**
	 * obiekt wyjsciowy drugiego gracza
	 */
	private ObjectOutputStream oosg2;
	/**
	 * obiekt wejsciowy pierwszego gracza
	 */
	private ObjectInputStream oisg1;
	/**
	 * obiekt wejsciowy drugiego gracza
	 */
	...
	/**
	 * Metoda do uruchomienia wątku serwera
	 */
	@Override
	public void run() {
		try {
	...
	/**
	 * Metoda przekazuja informacje o podlaczeniu graczy do serwera
	 * @param o obiekt wejsciowy
	 * @param s przekazywany ciag tekstowy
	 */
	...
	/**
	 * Metoda definiujaca parametry wyjsciowe po decyzjach graczy
	 * Obsluzone sa ruchy po moscie, spadanie do wody, ustawienie na kamieniach
	 * W koncu tu nastepuje podsumowanie punktacji graczy
	 */
