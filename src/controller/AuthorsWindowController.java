...
/**
 * Klasa obsluguje wyswietlanie okna z informacja o autorach
...
public class AuthorsWindowController {
	...
	/**
	 * Metoda do zamykania okna z informacja o autorach, z obsluga odtworzenia dzwieku
	 */
	@FXML public void closeAuth() {
		clickBut();
		stage.close();
	}
